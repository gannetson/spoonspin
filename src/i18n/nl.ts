...
export const nl: Messages = {
  ...
  "recipe.shoppingList.create": "Boodschappenlijstje maken",
  "recipe.shoppingList.kicker": "Te kopen",
  "recipe.shoppingList.title": "Boodschappenlijstje",
  "recipe.shoppingList.subtitle": "{name} · {count} porties",
  "recipe.shoppingList.closeAria": "Boodschappenlijstje sluiten",
  "recipe.shoppingList.itemsAria": "Ingrediënten om te kopen",
  "recipe.shoppingList.remove": "{name} verwijderen",
  "recipe.shoppingList.empty": "Niets meer te kopen. Voeg hieronder een item toe.",
  "recipe.shoppingList.addLabel": "Item toevoegen",
  "recipe.shoppingList.addPlaceholder": "bijv. melk, citroen, extra paprika",
  "recipe.shoppingList.add": "Toevoegen",
  "recipe.shoppingList.copy": "Lijst kopiëren",
  "recipe.shoppingList.copied": "Lijst gekopieerd",
  "recipe.shoppingList.share": "Delen",
  "recipe.shoppingList.shared": "Gedeeld",
  "recipe.shoppingList.whatsapp": "WhatsApp",
  "recipe.shoppingList.whatsappOpened": "WhatsApp wordt geopend",
  ...
  "order.option.eyebrow": "Besteloptie",
  "order.option.back": "Terug naar bestellijst",
  "order.option.notFound": "Die besteloptie is niet gevonden.",
  "order.option.openAria": "{name} openen",
  "order.option.view": "Bekijken",
  "order.option.open.thuisbezorgd": "Bestellen via Thuisbezorgd",
  "order.option.open.ubereats": "Bestellen via Uber Eats",
  "order.option.noLinks": "Nog geen bezorglinks.",
  ...
  "admin.item.editRestaurant": "Restaurant bewerken",
  "admin.item.editRestaurant.hint":
    "Bewerk handmatig naam, beschrijving, website en keukenlanden",
  "admin.item.editOrderOption": "Besteloptie bewerken",
  "admin.item.editOrderOption.hint":
    "Bewerk handmatig naam, beschrijving, landen en Thuisbezorgd- / Uber Eats-links",
  "admin.orderOption.edit.eyebrow": "Besteloptie",
  "admin.orderOption.edit.title": "{name} bewerken",
  "admin.orderOption.edit.subtitle":
    "Pas titel, beschrijving, keukenlanden en bezorglinks aan.",
  "admin.orderOption.edit.close": "Sluiten",
  "admin.orderOption.edit.name": "Naam",
  "admin.orderOption.edit.notes": "Beschrijving",
  "admin.orderOption.edit.notes.placeholder":
    "Wat te bestellen en waarom deze plek bij de keuken past…",
  ...
  "admin.orderOption.edit.links.hint":
    "Voeg één of beide links toe. Minstens één is verplicht.",
  "admin.orderOption.edit.countries": "Keukenlanden",
  "admin.orderOption.edit.countries.add": "Typ om een land toe te voegen…",
  ...
  "admin.restaurant.edit.subtitle":
    "Pas weergavenaam, beschrijving, websitelink en keukenlanden aan.",
  "admin.restaurant.edit.close": "Sluiten",
  "admin.restaurant.edit.name": "Naam",
  "admin.restaurant.edit.description": "Beschrijving",
  "admin.restaurant.edit.description.hint":
    "Korte authenticiteitstekst op de restaurantkaart en detailpagina.",
  "admin.restaurant.edit.description.placeholder":
    "Wat maakt deze plek een specialist voor deze keuken…",
  "admin.restaurant.edit.website": "Website",
  "admin.restaurant.edit.website.placeholder": "https://…",
  "admin.restaurant.edit.website.hint": "Laat leeg om de websitelink te wissen.",
  "admin.restaurant.edit.countries": "Keukenlanden",
  "admin.restaurant.edit.countries.search": "Zoek landen…",
  "admin.restaurant.edit.countries.add": "Typ om een land toe te voegen…",
  "admin.restaurant.edit.countries.addAnother": "Nog een toevoegen…",
  "admin.restaurant.edit.countries.clear": "Alles wissen",
  "admin.restaurant.edit.countries.remove": "{name} verwijderen",
  ...
  "admin.restaurant.edit.error.name": "Naam is verplicht.",
  "admin.restaurant.edit.error.website":
    "Voer een geldige website-URL in, of laat het veld leeg.",
  "admin.restaurant.edit.error.countries": "Selecteer minstens één keukenland.",
  "admin.restaurant.edit.error.save": "Kon restaurantwijzigingen niet opslaan.",
