...
export const en: Messages = {
  ...
  "cook.filter.alcohol.alcoholic": "Alcoholic",
  ...
  "cook.drinks.subtitle": "National drinks, beer, wine, and soft options.",
  ...
  "admin.country.findDrinks.hint":
    "Query national drinks, including local wines and beers",
  ...
  "admin.discover.drinks.hint":
    "Query for national drinks — especially local wines and beers — then pick which to add.",
  "admin.discover.drinks.placeholder":
    "e.g. regional wines, craft beers, non-alcoholic classics",
