...
export const en: Messages = {
  ...
  "privacy.marketing.body":
    "When you accept marketing cookies, some shop and order links (for example to Thuisbezorgd.nl) may use affiliate tracking via a partner network such as Awin when a programme is available. Attribution typically follows the partner’s cookie window. If you choose essential only, links open the platform directly with no affiliate tracking.",
  ...
  "recipe.shoppingList.create": "Create shopping list",
  "recipe.shoppingList.kicker": "To buy",
  "recipe.shoppingList.title": "Shopping list",
  "recipe.shoppingList.subtitle": "{name} · {count} servings",
  "recipe.shoppingList.closeAria": "Close shopping list",
  "recipe.shoppingList.itemsAria": "Ingredients to buy",
  "recipe.shoppingList.remove": "Remove {name}",
  "recipe.shoppingList.empty": "Nothing left to buy. Add an item below.",
  "recipe.shoppingList.addLabel": "Add an item",
  "recipe.shoppingList.addPlaceholder": "e.g. milk, lemon, extra peppers",
  "recipe.shoppingList.add": "Add",
  "recipe.shoppingList.copy": "Copy list",
  "recipe.shoppingList.copied": "List copied",
  "recipe.shoppingList.share": "Share",
  "recipe.shoppingList.shared": "Shared",
  "recipe.shoppingList.whatsapp": "WhatsApp",
  "recipe.shoppingList.whatsappOpened": "Opening WhatsApp",
  ...
  "order.option.eyebrow": "Order option",
  "order.option.back": "Back to order list",
  "order.option.notFound": "That order option was not found.",
  "order.option.openAria": "Open {name}",
  "order.option.view": "View",
  "order.option.open.thuisbezorgd": "Order on Thuisbezorgd",
  "order.option.open.ubereats": "Order on Uber Eats",
  "order.option.noLinks": "No delivery links yet.",
  ...
  "admin.item.editRestaurant": "Edit restaurant",
  "admin.item.editRestaurant.hint":
    "Manually edit name, description, website, and cuisine countries",
  "admin.item.editOrderOption": "Edit order option",
  "admin.item.editOrderOption.hint":
    "Manually edit name, description, countries, and Thuisbezorgd / Uber Eats links",
  "admin.orderOption.edit.eyebrow": "Order option",
  "admin.orderOption.edit.title": "Edit {name}",
  "admin.orderOption.edit.subtitle":
    "Update the title, description, cuisine countries, and delivery links.",
  "admin.orderOption.edit.close": "Close",
  "admin.orderOption.edit.name": "Name",
  "admin.orderOption.edit.notes": "Description",
  "admin.orderOption.edit.notes.placeholder":
  ...
  "admin.orderOption.edit.cancel": "Cancel",
  "admin.orderOption.edit.error.name": "Name is required.",
  "admin.orderOption.edit.error.countries": "Select at least one cuisine country.",
  "admin.orderOption.edit.error.url": "Enter a valid URL, or leave the field blank.",
  ...
  "admin.restaurant.edit.subtitle":
    "Update the display name, description, website link, and cuisine countries.",
  "admin.restaurant.edit.close": "Close",
  "admin.restaurant.edit.name": "Name",
  "admin.restaurant.edit.description": "Description",
  "admin.restaurant.edit.description.hint":
    "Short authenticity blurb shown on the restaurant card and detail page.",
  "admin.restaurant.edit.description.placeholder":
    "What makes this place a specialist for this cuisine…",
  "admin.restaurant.edit.website": "Website",
  "admin.restaurant.edit.website.placeholder": "https://…",
  "admin.restaurant.edit.website.hint": "Leave blank to clear the website link.",
  "admin.restaurant.edit.countries": "Cuisine countries",
  "admin.restaurant.edit.countries.search": "Search countries…",
  "admin.restaurant.edit.countries.add": "Type to add a country…",
  "admin.restaurant.edit.countries.addAnother": "Add another…",
  "admin.restaurant.edit.countries.clear": "Clear all",
  "admin.restaurant.edit.countries.remove": "Remove {name}",
  "admin.restaurant.edit.countries.hint":
    "Add one or more countries this restaurant’s cuisine belongs to.",
  "admin.restaurant.edit.countries.selected": "{count} selected",
  "admin.restaurant.edit.countries.empty": "No countries match that search.",
  "admin.restaurant.edit.save": "Save changes",
  "admin.restaurant.edit.saving": "Saving…",
  "admin.restaurant.edit.cancel": "Cancel",
  "admin.restaurant.edit.error.name": "Name is required.",
  "admin.restaurant.edit.error.website": "Enter a valid website URL, or leave it blank.",
  "admin.restaurant.edit.error.countries": "Select at least one cuisine country.",
  "admin.restaurant.edit.error.save": "Could not save restaurant edits.",
